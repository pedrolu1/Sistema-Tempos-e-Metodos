...
export const SEED_ATIVIDADES = [
  ...
  { codigo: 'M9', contrato: 'Reparo de Dutos Coletores', local: 'MONOLÍTICO', nome: 'Instalação do monolítico (mecânica)' },
  { codigo: 'M10', contrato: 'Reparo de Dutos Coletores', local: 'MONOLÍTICO', nome: 'Instalação do monolítico (refratário)' },
  { codigo: 'M11', contrato: 'Reparo de Dutos Coletores', local: 'MONOLÍTICO', nome: 'Ajuste e alinhamento do monolítico' },
  { codigo: 'M12', contrato: 'Reparo de Dutos Coletores', local: 'MONOLÍTICO', nome: 'Acabamento refratário do monolítico' },
  { codigo: 'M13', contrato: 'Reparo de Dutos Coletores', local: 'MONOLÍTICO', nome: 'Fechamento metálico do duto coletor' },
  ...
  { codigo: 'CLC12', contrato: 'Reparo de Cabeceiras do Forno', local: 'CABECEIRAS', nome: 'Instalação do protector plate inferior do forno' },
  { codigo: 'CLC13', contrato: 'Reparo de Cabeceiras do Forno', local: 'CABECEIRAS', nome: 'Recomposição refratária do protector plate inferior (assent. tijolos + concretagem)' },
  { codigo: 'CLC14', contrato: 'Reparo de Cabeceiras do Forno', local: 'CABECEIRAS', nome: 'Instalação do protector plate intermediário do forno (middle) lado direito' },
  { codigo: 'CLC15', contrato: 'Reparo de Cabeceiras do Forno', local: 'CABECEIRAS', nome: 'Instalação do protector plate intermediário do forno (middle) lado esquerdo' },
  { codigo: 'CLC16', contrato: 'Reparo de Cabeceiras do Forno', local: 'CABECEIRAS', nome: 'Instalação do protector plate superior do forno' },
  { codigo: 'CLC17', contrato: 'Reparo de Cabeceiras do Forno', local: 'CABECEIRAS', nome: 'Recomposição da parede jamb side lado direito e instalação da peça especial' },
  { codigo: 'CLC18', contrato: 'Reparo de Cabeceiras do Forno', local: 'CABECEIRAS', nome: 'Recomposição da parede jamb side lado esquerdo e instalação da peça especial' },
  { codigo: 'CLC19', contrato: 'Reparo de Cabeceiras do Forno', local: 'CABECEIRAS', nome: 'Montagem do arco do lintel monolítico' },
  { codigo: 'CLC20', contrato: 'Reparo de Cabeceiras do Forno', local: 'CABECEIRAS', nome: 'Instalação do buckstay horizontal superior do forno e troca das molas do buckstay vertical' },
  ...
  { codigo: 'CLC22', contrato: 'Reparo de Cabeceiras do Forno', local: 'CABECEIRAS', nome: 'Rejuntamento da abóbada inferior' },
  ...
  { codigo: 'CLC24', contrato: 'Reparo de Cabeceiras do Forno', local: 'CABECEIRAS', nome: 'Assentamento dos tijolos isolantes na abóbada do forno' },
  { codigo: 'CLC25', contrato: 'Reparo de Cabeceiras do Forno', local: 'CABECEIRAS', nome: 'Instalação da chapa de divisão e concretagem das extremidades da abóbada do forno (topo)' },
  { codigo: 'CLC26', contrato: 'Reparo de Cabeceiras do Forno', local: 'CABECEIRAS', nome: 'Assentamento dos tijolos impermeabilizantes (densos - 70 pac) do forno' },
  { codigo: 'CLC27', contrato: 'Reparo de Cabeceiras do Forno', local: 'CABECEIRAS', nome: 'Aplicação de massa isolante (silplate 1200) na cabeceira do forno (calafetagem)' },
  ...
  { codigo: 'PR3', contrato: 'Instalação de Primárias', local: 'TOPO DOS FORNOS', nome: 'Instalação das primárias novas' },
  { codigo: 'PR4', contrato: 'Instalação de Primárias', local: 'TOPO DOS FORNOS', nome: 'Revestimento da abóbada do forno' }
].map((item) => ({ ...item, tipo: 'produtiva' }));
